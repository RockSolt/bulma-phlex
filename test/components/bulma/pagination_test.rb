...
class Components::Bulma::PaginationTest < Minitest::Test
  ...
  def test_pagination_with_multiple_pages
    ...
    assert_html_includes result, '<a class="pagination-link is-current" aria-label="Page 5" aria-current="page">5</a>'
